 ...
 ;(function() {
	...
	$.fn.glDatePicker.defaults =
	{
		...
		onClick: (function(el, cell, date, data) {
                        ...
                        var datumString= datum+"-"+maand+"-"+jaar;
                        //tijd(el,date);
                        
			el.val(datumString);
                         if( el.attr('gldp-id')=="van"){
                            if($.find("#tijdDiv")){
                                $("body").append("<div class='tijd'id='tijdDiv'><label>Tijd(Om hoe laat-> HH:mm)</label><br>\n\
                                                  <input type='text'  class='datumInput' id='tijd'><br>\n\
                                                \n\
                                                <input type='button' class='divKnop' id='tijdKnop' value='Ok'>\n\
                                                  </div>");
                             $("#bdatum").attr("value",datumString);
                             $("#tijdKnop").click(function (){datumString+=" "+ $("#tijd").val(),$("#tijdDiv").remove(),el.val(datumString)});
//                           alert( $("#tijd").val())//datumString);
                               ;
                            }
                       };
                        if( el.attr('gldp-id')=="tot"){
                            if($.find("#tijdDiv")){
                                $("body").append("<div class='tijd'id='tijdDiv'><input type='text'  class='datumInput' id='tijd'><br>\n\
                                                <input type='button' class='divKnop' id='tijdKnop' value='Ok'>\n\
                                                  </div>");
	...
	var glDatePicker = (function() {
		...
		function glDatePicker(element, userOptions) {
			...
			var self = this;
                        ...
                        //alert(JSON.stringify($.fn.glDatePicker.defaults));
			...
			self.calendar = $($.find('[gldp-el=' + el.attr('gldp-id') + ' ]'));
                        //alert(JSON.stringify($.find('[gldp-el=' + el.attr('gldp-id') + ' ]')));
